...
class Mafia(commands.Cog):
    ...
    async def createmafia(self, ctx, name:str=None):
        ...
        def check(reaction, user):
            return user.id == ctx.author.id and str(reaction.emoji) == '1️⃣' or str(reaction.emoji) == '2️⃣' or str(reaction.emoji) == '3️⃣' or str(reaction.emoji) == '4️⃣' or str(reaction.emoji) == '5️⃣' or str(reaction.emoji) == '6️⃣' and reaction.message.id == msg.id
        ...
        while True:
            if user.id == ctx.author.id:
                ...
                if str(reaction.emoji) == '1️⃣':
                    print('escolheu 1'); return
                if str(reaction.emoji) == '2️⃣':
                    print('escolheu 2'); return
                if str(reaction.emoji) == '3️⃣':
                    print('escolheu 3'); return
                if str(reaction.emoji) == '4️⃣':
                    print('escolheu 4'); return
                if str(reaction.emoji) == '5️⃣':
                    print('escolheu 5'); return
                if str(reaction.emoji) == '6️⃣':
                    print('escolheu 6'); return
            else:
                pass
